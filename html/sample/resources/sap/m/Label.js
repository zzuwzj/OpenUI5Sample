...
sap.m.Label.prototype.setText=function(t){var v=this.getText();if(v!==t){this.setProperty("text",t,true);this.$().html(jQuery.sap.encodeHTML(this.getProperty("text")));if(t){this.$().removeClass("sapMLabelNoText")}else{this.$().addClass("sapMLabelNoText")}}return this};
